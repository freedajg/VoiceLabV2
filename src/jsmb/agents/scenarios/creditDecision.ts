/**
 * Scenario 2 — the flagship. A credit decision the system refuses to make on
 * its own, and a refusal path that produces genuinely different books.
 *
 * See ./index.ts for the scenario authoring rules.
 */
import type { Scenario, ScenarioStep } from "../../contracts/agents";

/* ── Figures used by this run ──────────────────────────────────────────── */
...
export const CREDIT_DECISION: Scenario = {
  id: "credit-decision",
